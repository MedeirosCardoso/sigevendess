...
public class ComponenteRepository extends GenericRepository<Componente, DaoInterface<Componente>> {

	public ComponenteRepository() {
		dao = new ComponenteDao();
		classe = Componente.class;
	}
	...
	public List<Componente> converterParaListaJava(String listaEmJson) {
		...
		try {
			List<Componente> lista = gson.fromJson(listaEmJson, collectionType);
			return lista;
		} catch (Exception e) {
